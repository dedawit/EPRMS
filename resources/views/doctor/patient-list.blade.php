        ...
        <div class="row">
            ...
            <table border="1" style="border-collapse:collapse;" class="table-container">
                <tr class="table-header" >
                    ...
                    <th class="border"> Previous Histories</th>
                ...
                <tr class="table-body" >
                    ...
                    <td class="border-black"> <a href="{{route('doctor.show-one-patient', [$user->id, $other->id])}}" class="btn btn-primary btn-blue my-2 ">View</a></td>
                    <td class="border-black"> <a href="{{route('doctor.patient-list-history', [$user->id, $other->id])}}" class="btn btn-primary btn-blue my-2 ">View</a></td>
