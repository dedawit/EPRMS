...
<body class="body-fill w-full">
    @include('admin.nav')
    {{-- main content --}}
    <!-- Offcanvas -->
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header">
        <h5 class="font-bold align-center" id="offcanvasExampleLabel">Manager Profile</h5>
        ...
        <div class="user-info flex items-start mb-4">
            <div>
                ...
                <div class="align-buttons">
                    <a href="{{ route('admin.show-password', $user->id) }}" class="btn btn-primary mx-2 my-2">Change Password</a>
                </div>
                <div>
                    ...
                    <a href="{{route('admin.help', $user)}}" class="btn btn-success mx-2 my-2">Help</a>
                </div>
            </div>
        </div>
    </div>
